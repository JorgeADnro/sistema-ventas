    ...
    iniciarSesion(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const isPasswordValid = yield utils_1.utils.checkPassword(password, usuario.password);
                if (!isPasswordValid) {
                    return res.status(404).json({ message: "El usuario o contraseña es incorrecto!" });
                }
                // Exclude sensitive information and generate JWT
                const { password: _, fechaRegistro } = usuario, newUser = __rest(usuario, ["password", "fechaRegistro"]);
